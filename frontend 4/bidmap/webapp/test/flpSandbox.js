		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bid Comparison Map",
									"targetURL": "#BidComparisonMap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"BidComparisonMap-display": {
								"semanticObject": "BidComparisonMap",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.southend.bidmap",
									"url": sap.ui.require.toUrl("com/southend/bidmap")
								}
							}
						}
					}
